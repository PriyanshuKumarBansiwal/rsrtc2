...
function Signup() {
    const { signupFormHandler } = useContext(MainContext)
    return (
        <div className='w-screen h-screen bg-white'>
            <div className='2xl:container w-full h-full mx-auto'>
                <div className='h-full w-full rounded-md overflow-hidden px-10 grid place-items-center'>
                    <form className='w-full flex flex-col rounded-md gap-5 bg-blue-600 text-white p-10' onSubmit={function (event) { signupFormHandler(event) }} method="post">
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <input maxLength={10} className='border rounded-md focus:outline-none p-3 text-black' name='contact_number' id='contact_number' type='number' />
                        </div>
